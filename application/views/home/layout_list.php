...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		<head>
			<title>VinaMos.vn - Tài Liệu Marketing Online</title>
...
<div class="news2">
			<div style="float:left;border:1px solid #fff;padding:3px;margin:4px">
                ...
                {
                ?>
					<img src="<?php echo base_url();?>file/uploads/property/<?php echo $list_product_cate['img'] ?>" alt="<?php echo $list_product_cate['title']?>" width="120">
                <?php } else {?>
