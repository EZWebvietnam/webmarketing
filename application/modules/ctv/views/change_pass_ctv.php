...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>ctv/homectv/change_pass" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform">
...
<script type="text/javascript">
    $(document).ready(function() {
       ...
       $('#old_pass').change(function(){
           $.ajax({
               type: "POST",
                    url: "<?php echo base_url();?>ctv/homectv/check_pass",
