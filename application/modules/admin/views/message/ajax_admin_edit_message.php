...
<div class="h-pop">
    ...
    <h3>Sửa: <?php echo $message[0]['title']?></h3>
</div>
<div class="m-pop">
    <script type="text/javascript" src="<?php echo base_url(); ?>template/ezwebvietnam/admin_cp/js/core/price_format.js"></script>
    <form action="<?php echo base_url(); ?>admin/messageadmin/edit/<?php echo $message[0]['id']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform">
        <table class="form" style="width: 1200px;">

            <tr>
                <td class="label">Tiêu đề</td>
                <td colspan="3">
                    <input id="title_" type="texbox" name="title" value="<?php echo $message[0]['title']?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea id="editor1" name="content"><?php echo $message[0]['content']?></textarea>
                    <script type="text/javascript">
