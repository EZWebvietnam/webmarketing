      ...
      <tr>
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            ...
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/customeradmin/deletes" method="post" accept-charset="utf-8" id="admindata_kh">
                  ...
                  <table class="admindata">
                     <thead>
                        <tr>
                           <th class="head" colspan="7">
                              <a class="del" onclick="return action_del('admindata_kh','mailbookcs');"><span>Xóa</span></a>                                Có <?php echo count($list_mail)?><span class="pages"><span class="pagebar-mainbody">
                           <?php 
                     ...
                     <tfoot>
                        <td colspan="7">
                           <a class="del" onclick="return action_del('admindata_kh','mailbookcs');"><span>Xóa</span></a>                            
