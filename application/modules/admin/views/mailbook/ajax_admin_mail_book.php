      ...
      <tr>
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            <table style="width: 100%;">
               <tr>
                  <td>
                     <div class="h-title">Danh sách Mail Book</div>
                     Quản lý email gửi sách cho khách hàng đăng ký. Mỗi lần đăng ký khách hàng sẽ được tự động random một sách trong list này
                  </td>
                  <td style="float: right;">
                     <div class="addlink"><a href="<?php echo base_url(); ?>admin/mailbook/add" class="add grouped_elements"><span>Thêm mới</span></a></div>
                  </td>
               </tr>
            </table>
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/mailbook/deletes" method="post" accept-charset="utf-8" id="admindata_mailbook">
                  ...
                  <table class="admindata">
                     ...
                     <tr class="row1 ">
                        ...
                        <td align="center"><a class="grouped_elements" href="<?php echo base_url();?>admin/mailbook/edit/<?php echo $product_ref['id']?>" title="Sửa"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/edit.png"></a>
                           <a class="delete_record" href="<?php echo base_url();?>admin/mailbook/delete/<?php echo $product_ref['id']?>" title="Xóa"><img src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/del.png"></a>        
               ...
               <script type="text/javascript">
                  function khachhang(page_no){  
                      load_show();   
                      $.post("<?php echo base_url();?>admin/mailbook/list_mailbook",{'page_no':page_no},function(data){
