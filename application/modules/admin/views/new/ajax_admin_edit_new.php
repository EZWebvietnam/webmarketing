    ...
    <form action="<?php echo base_url(); ?>admin/newsadmin/edit/<?php echo $detail[0]['id']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform" name="adminform">
        <table class="form" style="width: 1200px;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input id="title_" type="texbox" name="title" value="<?php echo $detail[0]['title']?>"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea id="editor2" name="editor2"><?php echo $detail[0]['content']?></textarea>
                    <script type="text/javascript">
        ...
        $("#adminform").validate({
            ...
            , submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    data: {file:$('#file').val(),editor2:content,title:$('#title_').val()},
                    dataType: "json",
                    cache: false,
