            ...
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/ctvadmin/deletes" method="post" accept-charset="utf-8" id="admindata_kh">
                  ...
                  <table class="admindata">
                     <thead>
                        <tr>
                           <th class="head" colspan="7">
                              <a class="del" onclick="return action_del('admindata_kh','account');"><span>Xóa</span></a>                                Có <?php echo count($list_ctv)?> CTV <span class="pages"><span class="pagebar-mainbody">
                           <?php 
                     ...
                     <tfoot>
                        <td colspan="7">
                           <a class="del" onclick="return action_del('admindata_kh','account');"><span>Xóa</span></a>                            
